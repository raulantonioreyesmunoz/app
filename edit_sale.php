  ...
  <div class="panel">
    <div class="panel-heading clearfix">
     ...
     <div class="pull-right">
       <a href="sales.php" class="btn btn-outline-primary btn-sm">Mostrar todas las solicitudes</a>
     </div>
    </div>
         ...
         <thead>
          ...
          <th> Acción</th>
           ...
           <tbody  id="product_info">
              <tr>
              <form method="post" action="edit_sale?id=<?php echo (int)$sale['id']; ?>">
                <td id="s_id">
                  <input type="text" class="form-control" id="sug_input" name="title" value="<?php echo remove_junk((int)$sale['id']); ?>">
                ...
                <td>
                  <button type="submit" name="update_sale" class="btn btn-outline-primary btn-sm">Actualizar solicitud</button>
                </td>
              </form>
              </tr>
           </tbody>
